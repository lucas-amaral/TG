...
\committee[Me.]{Pereira}{Adriano}{UFSM}
...
\begin{enumerate}
	...
	\item Inserção do Cucumber para descrever cenários para os testes.
	\item Implementar e disponibilizar suporte para funções Ajax na solução.
